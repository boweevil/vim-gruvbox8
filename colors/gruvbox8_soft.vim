...
" Last Updated: Wed Feb 15 20:34:27 2023
...
if &background ==# 'dark'
  ...
  if get(g:, "gruvbox_plugin_hi_groups", 1)
    ...
    hi! link CocInlayHintType NonText
    hi! link CocInlayHintParameter NonText
    ...
    hi LanguageClientErrorSign guifg=#fb4934 guibg=#32302f gui=NONE cterm=NONE
  ...
  " Light background
  if (has('termguicolors') && &termguicolors) || has('gui_running')
    let g:terminal_ansi_colors = ['#3c3836', '#cc241d', '#98971a', '#d79921', '#458588', '#b16286', '#689d6a', '#7c6f64', '#928374', '#9d0006', '#79740e', '#b57614', '#076678', '#8f3f71', '#427b58', '#f2e5bc']
  endif
  if has('nvim')
...
if s:t_Co >= 256
  if &background ==# 'dark'
    ...
    if get(g:, "gruvbox_plugin_hi_groups", 1)
      ...
      hi LanguageClientErrorSign ctermfg=203 ctermbg=236 cterm=NONE
    ...
    " Light background
    hi Terminal ctermfg=187 ctermbg=237 cterm=NONE
    if get(g:, 'gruvbox_transp_bg', 0)
